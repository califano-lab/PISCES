...
Finally, we identify the Master Regulators (the proteins that are most differentially active between clusters) using a Mann Whitney U-Test:
...
Next, we generate a set of scatter plots overlaying the activity of several proteins of interest:
